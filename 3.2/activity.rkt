; Thingy to disect formulas into their components
; Made by Alejandro Fernandez and Max Joshua
; Idk what else I am supposed to add
...
(define (floatMatch lst construct floatConstruct)
    (cond
        ...
        [(char=? (car lst) #\E) (sientificMatch lst construct floatConstruct)] ; go to scientific (kinda bodgy, but who cares)
